...
const std::unordered_map<std::string, OPCODETYPE> opcodeenum{
    ...
    {"looks_backdrops", OPCODETYPE(OPCODE::BACKDROPS, OPTYPE::SHADOW)},
    ...
    {"sound_changeeffectby", OPCODETYPE(OPCODE::CHANGE_SOUND_EFFECT_BY, OPTYPE::BLOCK)},
    {"sound_seteffectto", OPCODETYPE(OPCODE::SET_SOUND_EFFECT_TO, OPTYPE::BLOCK)},
